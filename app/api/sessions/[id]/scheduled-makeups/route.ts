import { listScheduledMakeupsForMissedSession } from "@/lib/attendance/makeup-booking";
...
export async function GET(_request: Request, { params }: Params) {
  try {
    ...
    const makeups = await listScheduledMakeupsForMissedSession(id);
    return jsonOk({ makeups });
  } catch (err) {
